...
public final class FragmentLicensesBinding implements ViewBinding {
  ...
  private FragmentLicensesBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView licenses) {
  ...
  public static FragmentLicensesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.licenses;
      RecyclerView licenses = ViewBindings.findChildViewById(rootView, id);
      if (licenses == null) {
        break missingId;
      }

      return new FragmentLicensesBinding((ConstraintLayout) rootView, licenses);
    }
