...
public final class ActivityStatsBinding implements ViewBinding {
  ...
  private ActivityStatsBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialTextView empty,
      @NonNull RecyclerView stats, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityStatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.stats;
      RecyclerView stats = ViewBindings.findChildViewById(rootView, id);
      if (stats == null) {
        break missingId;
      }
      ...
      return new ActivityStatsBinding((ConstraintLayout) rootView, empty, stats, toolbar);
    }
