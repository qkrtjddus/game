...
public final class FragmentHistoryBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView saveHistory;

  private FragmentHistoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialTextView empty, @NonNull CircularProgressIndicator loading,
      @NonNull RecyclerView saveHistory) {
  ...
  public static FragmentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.saveHistory;
      RecyclerView saveHistory = ViewBindings.findChildViewById(rootView, id);
      if (saveHistory == null) {
        break missingId;
      }

      return new FragmentHistoryBinding((ConstraintLayout) rootView, empty, loading, saveHistory);
    }
